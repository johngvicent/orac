  ...
  return (
    ...
    >
      ...
      <div className="aspect-square rounded-lg bg-midnight border border-white/10 overflow-hidden relative mb-2 group-hover:border-primary/30 transition-colors">
        ...
        {/* Etiqueta de precio */}
        <div className="absolute bottom-2 right-2 bg-linear-to-r from-[#BF953F] via-[#FCF6BA] to-[#AA771C] text-black px-2 py-0.5 rounded text-[10px] font-bold font-display shadow-lg">
          ${price}
        </div>
      </div>
